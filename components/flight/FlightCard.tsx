          ...
          <div className="w-[100%] flex justify-between">
            ...
            <article className="bg-emerald-100 h-[9.5vw] w-[9vw] rounded-md p-[2px] border-[1px] border-slate-400">
              <aside className="bg-emerald-600 h-[4.5vw] w-[103%] rounded-md flex">
                <FaStar className="text-neutral-100 scale-[0.6]" />{" "}
                <span className="font-sans font-semibold text-green-100 text-[10px] relative top-[1.5px] right-[1px]">
                  4.5
                </span>
              </aside>
              <aside className="font-sans font-semibold text-green-700 text-[10px] text-center">
                478
              </aside>
            </article>
          </div>
