    ...
    <article className="overflow-hidden h-[16vw] w-[90%] bg-white border-[1.5px] border-red-200 hover:border-neutral-700 transition-all duration-200 rounded-xl shadow-md">
          <div className="h-[75%] w-[100%] flex">
            <aside className="w-[30%] h-[100%] flex flex-col justify-between pl-6 py-6">
              <div>
                <h5 className="text-red-400 text-[11px] font-semibold"> via Howrah </h5>
              <h1 className="font-bold text-[19px] text-neutral-700 drop-shadow-md"> RoaminGo Shatabdi Express. </h1>
              <h6 className="text-[12px] text-neutral-500"> First-Class / Second-Class / Sleeper Coach Non-AC </h6>
              </div>
              <aside> <HoverRating /> </aside>
            </aside>
